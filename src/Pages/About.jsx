...
const About = () => {
  return (
    <Layout>
      {/* ── Background atmosphere (matches Home) ── */}
      ...
      <div className="mx-auto w-full max-w-6xl space-y-28 px-6 py-20">
        ...
        <section className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            {/* Back photo */}
            <div
              className="absolute left-0 top-0 overflow-hidden shadow-2xl shadow-zinc-900/20 dark:shadow-black/40"
            ...
            >
              ...
              <img
                ...
                className="h-60 w-48 object-cover grayscale-[20%]"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-zinc-950/50 via-transparent to-transparent" />
              <span
                className="absolute bottom-3 right-3 z-10 bg-zinc-950/80 px-2 py-1 text-[10px] text-zinc-300 backdrop-blur-sm"
                style={{ fontFamily: "'DM Mono', monospace" }}
              >
                02 / PORTRAIT
              </span>
            ...
            {/* Front photo */}
            <div
              className="absolute bottom-0 right-0 overflow-hidden shadow-2xl shadow-zinc-900/25 dark:shadow-black/50"
            ...
            >
              ...
              <img
                ...
                alt="Ricky portrait"
                className="h-64 w-52 object-cover grayscale-[10%] transition-all duration-500 hover:grayscale-0"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-zinc-950/40 via-transparent to-transparent" />
              <span
                className="absolute bottom-3 left-3 z-10 bg-zinc-950/80 px-2 py-1 text-[10px] text-zinc-300 backdrop-blur-sm"
                style={{ fontFamily: "'DM Mono', monospace" }}
              >
                01 / PORTRAIT
              </span>
        ...
        ══════════════════════════════ */}
        <section
          className="grid gap-px border border-zinc-200 bg-zinc-200 dark:border-zinc-800 dark:bg-zinc-800 md:grid-cols-3"
          style={{ animation: 'fade-up 0.7s ease 0.5s both' }}
        >
          {highlights.map((item) => (
            <div
              key={item.label}
              className="bg-white px-8 py-10 dark:bg-zinc-950"
            >
              ...
              <p className="mt-2 text-sm font-light text-zinc-500 dark:text-zinc-500">
                {item.sub}
              </p>
            </div>
          ))}
        ...
        {/* ══════════════════════════════
            EXPERTISE
        ══════════════════════════════ */}
        <section style={{ animation: 'fade-up 0.7s ease 0.6s both' }}>
          {/* Section header */}
          <div className="mb-12 flex items-end justify-between border-b border-zinc-200 pb-6 dark:border-zinc-800">
            <div>
          ...
          <div className="grid gap-px border border-zinc-200 bg-zinc-200 dark:border-zinc-800 dark:bg-zinc-800 md:grid-cols-3">
            {expertise.map((item) => (
              <div
                key={item.title}
                className="group bg-white px-8 py-10 transition-colors duration-300 hover:bg-zinc-50 dark:bg-zinc-950 dark:hover:bg-zinc-900/80"
              >
                <span
                  className="mb-6 block text-[11px] tracking-[0.15em] text-zinc-400 dark:text-zinc-600"
                  style={{ fontFamily: "'DM Mono', monospace" }}
                >
                  {item.index}
                </span>
                ...
                <p className="mb-6 text-sm font-light leading-7 text-zinc-600 dark:text-zinc-400">
                  {item.description}
                </p>
        ...
        ══════════════════════════════ */}
        <section
          className="relative overflow-hidden bg-zinc-950 p-10 dark:bg-black"
          ...
          <div className="relative z-10">
            ...
            <ul className="flex flex-wrap gap-3">
              {skills.map((skill) => (
                <li
                  key={skill}
                  className="border border-zinc-800 px-4 py-2 text-sm text-zinc-300 transition-colors duration-200 hover:border-zinc-500 hover:text-zinc-100"
